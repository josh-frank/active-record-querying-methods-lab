class Show < ActiveRecord::Base
    ...
    # - `shows_by_alphabetical_order`: returns an array of all of the shows sorted in alphabetical order according to their names. _hint_: use the `order` Active Record method.
